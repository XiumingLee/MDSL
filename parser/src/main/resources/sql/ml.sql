...
--- 第三个
--- MODEL换成TABLE ,INPUT_LABEL_COLS=['BODY_MASS_G']标准SQL不支持数组
--- 来自：https://cloud.google.com/bigquery-ml/docs/linear-regression-tutorial?hl=zh-cn#step_two_create_your_model
